...
usage()
{
	...
	echo "ADMIN_URL defaults to t3://spbws-prc554:10001 if not set as an environment variable or the second command-line parameter."
	...
	echo "for example:"
	echo "$1 managedserver1 t3://spbws-prc554:10001 weblogic weblogic"
}
...
if [ "$1" = "" ] ; then
	if [ "${ADMIN_URL}" = "" ] ; then
		ADMIN_URL="t3://spbws-prc554:10001"
		export ADMIN_URL
	fi
else
	ADMIN_URL="$1"
