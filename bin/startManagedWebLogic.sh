...
usage()
{
	...
	echo "for example:"
	echo "$1 managedserver1 http://spbws-prc554:10001"
}
...
DOMAIN_NAME="ecare_dev"

ADMIN_URL="http://spbws-prc554:10001"
...
JAVA_OPTIONS="-Dweblogic.security.SSL.trustedCAKeyStore="C:/Oracle/Middleware/wlserver_12.1/server/lib/cacerts" ${JAVA_OPTIONS}"
export JAVA_OPTIONS
