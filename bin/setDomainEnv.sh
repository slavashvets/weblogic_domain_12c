...
# (http://download.oracle.com/docs/cd/E24329_01/web.1211/e21048/overview.htm).
# *************************************************************************

WL_HOME="C:/Oracle/Middleware/wlserver_12.1"
export WL_HOME

BEA_JAVA_HOME="C:/Program Files/Java/jrockit-jdk1.6.0_37-R28.2.5-4.1.0"
...
if [ "${JAVA_VENDOR}" = "Oracle" ] ; then
	...
	if [ "${JAVA_VENDOR}" = "Sun" ] ; then
		...
		JAVA_VENDOR="Oracle"
		export JAVA_VENDOR
		JAVA_HOME="C:/Program Files/Java/jrockit-jdk1.6.0_37-R28.2.5-4.1.0"
		export JAVA_HOME
	fi
fi
...
DOMAIN_HOME="C:/Oracle/Middleware/user_projects/domains/ecare_dev"
export DOMAIN_HOME

LONG_DOMAIN_HOME="C:/Oracle/Middleware/user_projects/domains/ecare_dev"
